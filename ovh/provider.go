...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ovh_dedicatedclouds":                                     dataSourceDedicatedClouds(),
			"ovh_dedicatedcloud":                                      dataSourceDedicatedCloud(),
			"ovh_dedicatedcloud_allowednetworks":                      dataSourceDedicatedCloudAllowedNetworks(),
			...
			"ovh_dedicatedcloud_datacenter":                           dataSourceDedicatedCloudDatacenter(),
			"ovh_dedicatedcloud_datacenter_clusters":                  dataSourceDedicatedCloudDatacenterClusters(),
			"ovh_dedicatedcloud_datacenter_cluster":                   dataSourceDedicatedCloudDatacenterCluster(),
			"ovh_dedicatedcloud_datacenter_filers":                    dataSourceDedicatedCloudDatacenterFilers(),
			"ovh_dedicatedcloud_datacenter_tasks":                     dataSourceDedicatedCloudDatacenterTasks(),
			"ovh_dedicatedcloud_datacenter_task":                      dataSourceDedicatedCloudDatacenterTask(),
			"ovh_dedicatedcloud_commercialranges":                     dataSourceDedicatedCloudCommercialRanges(),
			"ovh_dedicatedcloud_commercialrange":                      dataSourceDedicatedCloudCommercianRange(),
			"ovh_dedicatedcloud_filers":                               dataSourceDedicatedCloudFilers(),
			"ovh_dedicatedcloud_filer":                                dataSourceDedicatedCloudFiler(),
			"ovh_dedicatedcloud_locations":                            dataSourceDedicatedCloudLocations(),
			"ovh_dedicatedcloud_location":                             dataSourceDedicatedCloudLocation(),
			"ovh_dedicatedcloud_location_hostprofiles":                dataSourceDedicatedCloudLocationHostProfiles(),
			"ovh_dedicatedcloud_location_hypervisors":                 dataSourceDedicatedCloudLocationHypervisors(),
			"ovh_dedicatedcloud_users":                                dataSourceDedicatedCloudUsers(),
			"ovh_dedicatedcloud_user":                                 dataSourceDedicatedCloudUser(),
			"ovh_dedicatedcloud_user_tasks":                           dataSourceDedicatedCloudUserTasks(),
			"ovh_dedicatedcloud_user_task":                            dataSourceDedicatedCloudUserTask(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ovh_dedicatedcloud_user":                                     resourceDedicatedCloudUser(),
